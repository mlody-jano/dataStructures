...
## About
This project contains three implementations of a **dictionary** in C++, which is a fundamental structure used for representing a set of key-value pairs. The program enables users to choose between two modes of running:
